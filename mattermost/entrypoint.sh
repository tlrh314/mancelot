...
POSTGRES_PORT_NUMBER=${DB_PORT_NUMBER:-5432}
...
if [ "$1" = 'mattermost' ]; then
  ...
  then
    ...
    export MM_SQLSETTINGS_DATASOURCE="postgres://$MM_USERNAME:$ENCODED_PASSWORD@$POSTGRES_HOST:$POSTGRES_PORT_NUMBER/$MM_DBNAME?sslmode=disable&connect_timeout=10"
    echo OK
  else
